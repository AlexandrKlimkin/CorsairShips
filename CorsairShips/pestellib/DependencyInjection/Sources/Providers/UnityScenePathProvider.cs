...
{
	public class UnityScenePathProvider<T> : IObjectProvider<T> where T:class
	{
		private readonly string _path;

		public UnityScenePathProvider(string path)
		{
			_path = path;
		}
		...
		{
			var gameObject = new UnityMaskFinder().Find(_path);
			if (gameObject == null)
