...
public class SimpleLOD_Editor : MonoBehaviour {
    ...
    public static ModelImporterMeshCompression MeshCompression = ModelImporterMeshCompression.Medium;
		...
		if(path != null) {
			...
			if(meshes != null && meshes.Length > 0) {
				...
				for(int i=0;i<meshes.Length;i++) {
                    ...
                    MeshUtility.SetMeshCompression(meshes[i], SimpleLOD_Editor.MeshCompression);
		...
		if(path != null) {
			...
			if(mesh != null) {
				...
				if(mesh != null && mesh.vertexCount > 0) {
                    MeshUtility.SetMeshCompression(mesh, SimpleLOD_Editor.MeshCompression);
