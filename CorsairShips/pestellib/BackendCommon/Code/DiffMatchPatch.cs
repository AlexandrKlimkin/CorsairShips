    ...
    public class Patch
    {
        ...
        public override string ToString()
        {
            ...
            foreach (Diff aDiff in this.diffs)
            {
                ...
                text.Append((string) HttpUtility.UrlEncode(aDiff.text,
    ...
    public class diff_match_patch
    {
        ...
        public string diff_prettyHtml(List<Diff> diffs)
        {
            ...
            foreach (Diff aDiff in diffs)
            {
                ...
                foreach (var line in lines)
                {
                    ...
                    resultingText.AppendLine(Tabs(count) + trimmedLine);
                }

                text = resultingText.ToString();
                text = text.Replace("\r\n", "<br>");
        ...
        public string diff_toDelta(List<Diff> diffs)
        {
            ...
            foreach (Diff aDiff in diffs)
            {
                ...
                {
                    case Operation.INSERT:
                        text.Append("+").Append((string) HttpUtility.UrlEncode(aDiff.text,
                            new UTF8Encoding()).Replace('+', ' ')).Append("\t");
                        break;
                    case Operation.DELETE:
