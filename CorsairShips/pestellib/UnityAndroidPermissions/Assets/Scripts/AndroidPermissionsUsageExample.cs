...
public class AndroidPermissionsUsageExample : MonoBehaviour
{
    ...
    {
        Debug.Log("OnGrantButtonPress. Requesting");
    ...
    public void ShouldShowRequestPermission()
    {
        Debug.Log("ShouldShowRequestPermission " + AndroidPermissionsManager.ShouldShowRequestPermission(STORAGE_PERMISSION));
    }

    public void GoToSettings()
    {
        AndroidPermissionsManager.GoToAppSettings();
    }
