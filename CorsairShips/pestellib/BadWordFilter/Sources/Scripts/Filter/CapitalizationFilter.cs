    ...
    public class CapitalizationFilter : BaseFilter
    {
        ...
        public int CharacterNumber
        {
            ...
            set
            {
                ...
                RegularExpression = new System.Text.RegularExpressions.Regex(@"\b\w*[A-ZÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÚÛÜÝА-Я]{" + (characterNumber + 1) + @",}\w*\b", System.Text.RegularExpressions.RegexOptions.CultureInvariant);
            }
        }
        ...
        public override string Replace(string text, System.Collections.Generic.List<string> badWords, bool markOnly, string prefix = "", string postfix = "")
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        result = result.Replace(badword, markOnly ? prefix + badword + postfix : prefix + badword.ToLowerInvariant() + postfix);
                    }
                }
            }
