...
namespace UnityEngine.UI
{
    ...
    public class CarouselScrollRect : UnityEngine.EventSystems.UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        public Vector2 m_PointerStartLocalCursor = Vector2.zero;
       ...
       protected override void OnEnable()
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            if (m_Content.anchoredPosition.y < 0) 
                offset = m_Content.anchoredPosition;
            if (m_Content.anchoredPosition.y > m_Viewport.rect.height) {
                offset = m_Content.anchoredPosition;
                offset.y -= m_Viewport.rect.height;
            }

            if (offset.magnitude > 0)
                pointerDelta *= (float)(Math.Exp(-Mathf.Abs(offset.y)/25));
