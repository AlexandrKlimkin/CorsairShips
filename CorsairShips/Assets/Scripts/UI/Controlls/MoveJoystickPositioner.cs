...
public class MoveJoystickPositioner : OnScreenControl
{
    ...
    [SerializeField] private RectTransform joystickCircleBig;
    [SerializeField] private RectTransform joystickCircleSmall;
    ...
    private void UpdateOnTap(Vector2 tapPosition, int id)
    {
        ...
        if (tapPosition.x / Screen.width < joystickZoneSizePct.x && tapPosition.y / Screen.height < joystickZoneSizePct.y)
        {
            joysticFingerId = id;
