...
namespace NorskaLib.Utilities
{
    public struct GUIUtils
    {
        ...
        {
            var hitObjects = GetUIElements(atScreenPosition);
        ...
        public static List<GameObject> GetUIElements(Vector2 atScreenPosition)
        {
